...
impl Window {
    ...
    /// Deprecated alias for `paint_image_with_corner_superellipse`.
    #[deprecated(note = "Use paint_image_with_corner_superellipse instead.")]
...
impl PaintQuad {
    ...
    /// Deprecated alias for `corner_superellipse`.
    #[deprecated(note = "Use corner_superellipse instead.")]
    pub fn smoothness(self, smoothness: f32) -> Self {
        self.corner_superellipse(smoothness)
    }
}
